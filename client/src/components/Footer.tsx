  ...
  return (
    <footer className="relative bg-black pt-16 pb-8">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4 mt-6">
              <a href="https://www.linkedin.com/company/south-media/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-[rgba(127,49,184,0.3)] flex items-center justify-center hover:bg-[rgba(127,49,184,0.15)] transition-all" aria-label="LinkedIn">
              ...
              <a href="https://www.instagram.com/southmedia.br" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-[rgba(127,49,184,0.3)] flex items-center justify-center hover:bg-[rgba(127,49,184,0.15)] transition-all" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/southmedia.br/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-[rgba(127,49,184,0.3)] flex items-center justify-center hover:bg-[rgba(127,49,184,0.15)] transition-all" aria-label="Facebook">
          ...
          {/* Contato */}
          <div>
            <h4 className="font-['Inter'] font-bold text-white text-sm mb-4 tracking-wide">Contato</h4>
            <ul className="space-y-3">
              <li>
                <a href={WA_FOOTER} target="_blank" rel="noopener noreferrer" className="text-white/60 text-sm hover:text-white transition-colors flex items-center gap-2">
              ...
              <li>
                <a href="mailto:comercial@southmedia.com.br" className="text-white/60 text-sm hover:text-white transition-colors flex items-center gap-2">
        ...
        {/* Bottom bar */}
        <div className="border-t border-[rgba(127,49,184,0.2)] pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/50 text-xs text-center md:text-left">
            &copy; 2025 South Media. Tecnologia 100% Proprietária. Feito no Brasil.
          </p>
          <div className="flex gap-4">
            <Link href="/politica-privacidade" className="text-white/50 text-xs hover:text-white transition-colors">Política de Privacidade</Link>
            <span className="text-white/50 text-xs">Termos de Uso</span>
          </div>
        </div>
      </div>
    </footer>
