        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4 mt-6">
              ...
              <a href="https://www.facebook.com/southmedia.br/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-[rgba(155,0,255,0.3)] flex items-center justify-center hover:bg-[rgba(155,0,255,0.15)] transition-all" aria-label="Facebook">
