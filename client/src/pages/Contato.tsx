    ...
    <div ref={scrollRef}>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 animate-on-scroll">
              <form onSubmit={handleSubmit} className="glass-card p-8 space-y-6">
                <h2 className="font-['Syne'] font-bold text-white text-2xl mb-2">Solicite sua Proposta</h2>

                <div className="grid md:grid-cols-2 gap-6">
                  <div className="relative">
                    <input type="text" id="nome" required className="peer w-full px-4 py-3 pt-6 rounded-xl bg-[rgba(255,255,255,0.06)] border border-[rgba(155,0,255,0.3)] text-white focus:border-[#9B00FF] focus:outline-none transition-colors font-['DM_Sans'] placeholder-transparent" placeholder="Nome completo" />
                    <label htmlFor="nome" className="absolute left-4 top-2 text-[#888] text-xs font-['DM_Sans'] transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-focus:top-2 peer-focus:text-xs peer-focus:text-[#9B00FF]">Nome completo</label>
                  </div>
                  <div className="relative">
                    <input type="email" id="email" required className="peer w-full px-4 py-3 pt-6 rounded-xl bg-[rgba(255,255,255,0.06)] border border-[rgba(155,0,255,0.3)] text-white focus:border-[#9B00FF] focus:outline-none transition-colors font-['DM_Sans'] placeholder-transparent" placeholder="E-mail corporativo" />
                    <label htmlFor="email" className="absolute left-4 top-2 text-[#888] text-xs font-['DM_Sans'] transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-focus:top-2 peer-focus:text-xs peer-focus:text-[#9B00FF]">E-mail corporativo</label>
                  </div>
                  <div className="relative">
                    <input type="text" id="empresa" required className="peer w-full px-4 py-3 pt-6 rounded-xl bg-[rgba(255,255,255,0.06)] border border-[rgba(155,0,255,0.3)] text-white focus:border-[#9B00FF] focus:outline-none transition-colors font-['DM_Sans'] placeholder-transparent" placeholder="Empresa" />
                    <label htmlFor="empresa" className="absolute left-4 top-2 text-[#888] text-xs font-['DM_Sans'] transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-focus:top-2 peer-focus:text-xs peer-focus:text-[#9B00FF]">Empresa</label>
                  </div>
                  <div className="relative">
                    <input type="text" id="cargo" className="peer w-full px-4 py-3 pt-6 rounded-xl bg-[rgba(255,255,255,0.06)] border border-[rgba(155,0,255,0.3)] text-white focus:border-[#9B00FF] focus:outline-none transition-colors font-['DM_Sans'] placeholder-transparent" placeholder="Cargo" />
                    <label htmlFor="cargo" className="absolute left-4 top-2 text-[#888] text-xs font-['DM_Sans'] transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-focus:top-2 peer-focus:text-xs peer-focus:text-[#9B00FF]">Cargo</label>
                  </div>
                  <div className="relative">
                    <input type="tel" id="telefone" className="peer w-full px-4 py-3 pt-6 rounded-xl bg-[rgba(255,255,255,0.06)] border border-[rgba(155,0,255,0.3)] text-white focus:border-[#9B00FF] focus:outline-none transition-colors font-['DM_Sans'] placeholder-transparent" placeholder="Telefone / WhatsApp" />
                    <label htmlFor="telefone" className="absolute left-4 top-2 text-[#888] text-xs font-['DM_Sans'] transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-focus:top-2 peer-focus:text-xs peer-focus:text-[#9B00FF]">Telefone / WhatsApp</label>
                  </div>
                  <div className="relative">
                    <select className="w-full px-4 py-3 pt-6 rounded-xl bg-[rgba(255,255,255,0.06)] border border-[rgba(155,0,255,0.3)] text-white focus:border-[#9B00FF] focus:outline-none transition-colors font-['DM_Sans'] appearance-none">
                      <option value="" className="bg-[#0d0015]">Selecione o segmento</option>
                      {segmentos.map((s) => (
                        <option key={s} value={s} className="bg-[#0d0015]">{s}</option>
                      ))}
                    </select>
                    <label className="absolute left-4 top-2 text-[#888] text-xs font-['DM_Sans']">Segmento</label>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <label className="absolute left-4 top-2 text-[#888] text-xs font-['DM_Sans']">Orçamento mensal estimado</label>
                </div>

                <div>
                  <p className="text-[#888] text-sm mb-3 font-['DM_Sans']">Objetivo principal</p>
                ...
                <div className="relative">
                  <textarea id="mensagem" rows={4} className="peer w-full px-4 py-3 pt-6 rounded-xl bg-[rgba(255,255,255,0.06)] border border-[rgba(155,0,255,0.3)] text-white focus:border-[#9B00FF] focus:outline-none transition-colors font-['DM_Sans'] placeholder-transparent resize-none" placeholder="Mensagem" />
                  <label htmlFor="mensagem" className="absolute left-4 top-2 text-[#888] text-xs font-['DM_Sans'] transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-focus:top-2 peer-focus:text-xs peer-focus:text-[#9B00FF]">Mensagem (opcional)</label>
                </div>
            ...
            <div className="space-y-6 animate-on-scroll">
              <div className="glass-card p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="font-['Syne'] font-bold text-white text-sm">WhatsApp</p>
              ...
              <div className="glass-card p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="font-['Syne'] font-bold text-white text-sm">E-mail</p>
              ...
              <div className="glass-card p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="font-['Syne'] font-bold text-white text-sm">LinkedIn</p>
              ...
              {/* Mini Brazil Map */}
              <div className="glass-card p-6">
                <p className="font-['Syne'] font-bold text-white text-sm mb-4">Presença Nacional</p>
                <div className="flex flex-wrap gap-2">
                  {["Paraná", "Santa Catarina", "São Paulo", "Pernambuco"].map((state) => (
                  ...
                  <span className="flex items-center gap-2">
                    ...
                    <span className="text-[#FF4500] text-sm font-bold">+ LATAM</span>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {faqs.map((faq, i) => (
              <div key={i} className="glass-card overflow-hidden animate-on-scroll">
                ...
                >
                  <span className="font-['Syne'] font-bold text-white text-base pr-4">{faq.q}</span>
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 24 24"
      ...
      <section className="section-orange-purple py-20 noise-overlay">
        <div className="container relative z-10 text-center">
          <h2 className="font-['Syne'] font-extrabold text-white text-3xl md:text-4xl mb-6 animate-on-scroll">
