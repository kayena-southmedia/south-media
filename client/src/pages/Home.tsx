      ...
      <section className="relative py-20 overflow-hidden noise-overlay">
        ...
        <div className="container relative z-10">
          ...
          <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 md:gap-6">
            {[
              "Display", "CTV", "Publishers Regionais", "Drive to Store",
              "Audience Insights", "Household Sync", "App Marketing & SMS",
              "Push", "DOOH", "Spotify", "TikTok Remarketing", "In-Games",
            ].map((item) => (
              <div key={item} className="glass-card p-4 text-center animate-on-scroll group">
