        ...
        <div className="container relative z-10">
          ...
          <div className="max-w-3xl mx-auto animate-on-scroll">
            ...
            <div className="relative w-full max-w-[600px] mx-auto">
              ...
              />
              {/* SVG overlay for spiral connection lines */}
              <svg
              ...
              >
                <defs>
                  <linearGradient id="spiralGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#9B00FF" stopOpacity="0.7" />
                ...
                {/* Spiral path: Pernambuco → São Paulo → Lima → Buenos Aires → Paraná → Santiago → Santa Catarina */}
                {/* This traces a spiral-like pattern reminiscent of the South Media logo icon */}
                <path
                  d="M 78 32 Q 72 40, 62 55 Q 50 45, 28 42 Q 30 55, 48 72 Q 50 65, 56 60 Q 42 62, 32 68 Q 40 68, 55 64"
                  fill="none"
                ...
                {/* Secondary connecting arcs for depth */}
                <path
                  d="M 62 55 Q 55 62, 48 72"
                  fill="none"
                  stroke="#9B00FF"
                  strokeWidth="0.2"
                ...
                <path
                  ...
                  opacity="0.5"
                >
                  <animate attributeName="stroke-dashoffset" values="0;-6" dur="7s" repeatCount="indefinite" />
                </path>
                <path
                  d="M 78 32 Q 60 30, 28 42"
                  fill="none"
                  stroke="#FF6B00"
                  strokeWidth="0.15"
                  ...
                  opacity="0.35"
                >
                  <animate attributeName="stroke-dashoffset" values="0;-8" dur="10s" repeatCount="indefinite" />
                </path>
              </svg>
